...
import com.example.loginmine.dao.NaverAsyncTask
import com.example.loginmine.datatype.User
import com.example.loginmine.repository.LoginRepository
import com.example.loginmine.utils.ActivityNavigation
import com.example.loginmine.utils.LiveMessageEvent
import com.example.loginmine.utils.SingleLiveEvent
...
class LoginViewModel : ViewModel() {
    ...
    fun naverLogInCallback(result: String) {
        ...
        val nickname = responseObject.getString("nickname")
        updateUI(nickname)
    }
